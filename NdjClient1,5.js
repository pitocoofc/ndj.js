...
this.vars.botName = data.user.username;
this.vars.botId = data.user.id;
...
this.vars.guilds.set(data.id,data);
this.vars.guildCount = this.vars.guilds.size;
...
this.vars.users.set(data.author.id,data.author);
this.vars.userCount = this.vars.users.size;
